...
$string['choosereadme'] = '<p>Firefly is base on the More theme and as such is a theme that allows you to easily customise Moodle\'s look and feel directly from the web interface.</p>
<p>Visit the admin settings to change colours, add an image as a background, add your logo and more...</p>';

$string['configtitle'] = 'Firefly';
