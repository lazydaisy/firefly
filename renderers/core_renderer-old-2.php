    ...
    */
    ...
    protected function render_pix_icon(pix_icon $icon) {
        ...
        if ($component == 'mod_assign') {
            return html_writer::tag('i', '', array('class' => 'fa fa-book'));
        } else if ($component == 'mod_assignment') {
            return html_writer::tag('i', '', array('class' => 'fa fa-book'));
        } else if ($component == 'mod_book') {
            return html_writer::tag('i', '', array('class' => 'fa fa-book'));
        } else if ($component == 'mod_chat') {
            return html_writer::tag('i', '', array('class' => 'fa fa-comment-o'));
        } else if ($component == 'mod_choice') {
            return html_writer::tag('i', '', array('class' => 'fa fa-question'));
        } else if ($component == 'mod_data') {
            return html_writer::tag('i', '', array('class' => 'fa fa-database'));
        } else if ($component == 'mod_feedback') {
            return html_writer::tag('i', '', array('class' => 'fa fa-bullhorn'));
        } else if ($component == 'mod_folder') {
            return html_writer::tag('i', '', array('class' => 'fa fa-folder-open'));
        } else if ($component == 'mod_forum') {
            return html_writer::tag('i', '', array('class' => 'fa fa-comments-o'));
        } else if ($component == 'mod_glossary') {
            return html_writer::tag('i', '', array('class' => 'fa fa-sort-alpha-asc'));
        } else if ($component == 'mod_imscp') {
            return html_writer::tag('i', '', array('class' => 'fa fa-stack-overflow'));
        } else if ($component == 'mod_label') {
            return html_writer::tag('i', '', array('class' => 'fa fa-tag'));
        } else if ($component == 'mod_lesson') {
            return html_writer::tag('i', '', array('class' => 'fa fa-mortar-board'));
        } else if ($component == 'mod_lti') {
            return html_writer::tag('i', '', array('class' => 'fa fa-puzzle-piece'));
        } else if ($component == 'mod_page') {
            return html_writer::tag('i', '', array('class' => 'fa fa-file-text-o'));
